    ...
    <StyledWrapper>
      <Modal size="sm" title={'Support'} handleCancel={onClose} hideFooter={true}>
        <div className="collection-options">
          ...
          <div className="mt-2">
            <a href="https://github.com/bluepaper-io/blue/issues" target="_blank" className="flex items-end">
              <IconSpeakerphone size={18} strokeWidth={2} />
              <span className="label ml-2">Report Issues</span>
            </a>
          </div>
          <div className="mt-2">
            <a href="https://github.com/bluepaper-io/blue" target="_blank" className="flex items-end">
